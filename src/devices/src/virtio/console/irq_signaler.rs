...
impl Clone for IRQSignaler {
    fn clone(&self) -> Self {
        Self {
            interrupt_status: self.interrupt_status.clone(),
            interrupt_evt: self.interrupt_evt.try_clone().expect("Failed to clone EventFd"),
...
impl IRQSignaler {
    ...
    pub fn new() -> IRQSignaler {
        Self {
            ...
            interrupt_evt: EventFd::new(utils::eventfd::EFD_NONBLOCK).unwrap(), //TODO
            intc: None,
            irq_line: None,
        }
    }
