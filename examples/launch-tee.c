...
int main(int argc, char *const argv[])
{
    ...
    // Configure the console.
    {
        ...
        CHECK(krun_console_builder_add_default_console(cb, dup(STDIN_FILENO), dup(STDOUT_FILENO), dup(STDERR_FILENO), &krun_err));
    ...
    krun_vmm_builder_add_serial_console(&builder, -1, dup(STDOUT_FILENO));
