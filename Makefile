LIBRARY_HEADER_TYPED = include/libkrun2.h
...
.PHONY: install clean test test-prefix gen-libkrun-bindings verify-libkrun-bindings gen-init-blob-bindings verify-init-blob-bindings $(LIBRARY_RELEASE_$(OS)) $(LIBRARY_DEBUG_$(OS)) libkrun.pc libkrun_init.pc clean-sysroot clean-all

all: $(LIBRARY_RELEASE_$(OS)) libkrun.pc libkrun_init.pc

debug: $(LIBRARY_DEBUG_$(OS)) libkrun.pc libkrun_init.pc

# Regenerate the ffier JSON schema, C header, and Rust clients for the typed
# libkrun API. Run this after changing anything under the `#[ffier::export]`
# surface in src/libkrun/src/api/. Built with blk,net,vhost-user so the
# generated clients cover those feature-gated devices too (gpu/input pull in
# extra system deps and aren't included).
GEN_BINDINGS_FEATURES = ffi,blk,net,vhost-user
gen-libkrun-bindings:
	cargo build -p libkrun --features $(GEN_BINDINGS_FEATURES)
	cp target/ffier-krun.json include/ffier-krun2.json
	{ echo '/* @generated by: make gen-libkrun-bindings — do not edit manually. */'; \
	  cargo run -p libkrun --features $(GEN_BINDINGS_FEATURES) --bin libkrun-gen -- c-header; } > $(LIBRARY_HEADER_TYPED)
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features $(GEN_BINDINGS_FEATURES) --bin libkrun-gen -- rust-client --weak; } > src/libkrun-via-cdylib-weak/src/lib.rs
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features $(GEN_BINDINGS_FEATURES) --bin libkrun-gen -- rust-client; } > src/libkrun-via-cdylib/src/lib.rs

# Verify that checked-in generated files are up to date (for CI).
verify-libkrun-bindings: gen-libkrun-bindings
	@git diff --exit-code include/ffier-krun2.json \
		$(LIBRARY_HEADER_TYPED) \
		src/libkrun-via-cdylib-weak/src/lib.rs \
		src/libkrun-via-cdylib/src/lib.rs \
...
gen-init-blob-bindings:
	...
	{ echo '/* @generated by: make gen-init-blob-bindings — do not edit manually. */'; \
	  cargo run -p krun-init-blob --features ffi --bin krun-init-blob-gen c-header; } > $(LIBRARY_HEADER_INIT)
...
install: libkrun.pc libkrun_init.pc
	...
	install -m 644 $(LIBRARY_HEADER_TYPED) $(DESTDIR)$(PREFIX)/include
