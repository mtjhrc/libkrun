...
gen-libkrun-bindings:
	cargo build -p libkrun --features ffi,blk,net,vhost-user
	cp target/ffier-krun.json include/ffier-krun.json
	{ echo '/* @generated by: make gen-libkrun-bindings — do not edit manually. */'; \
	  cargo run -p libkrun --features ffi,blk,net,vhost-user --bin libkrun-gen -- c-header; } > $(LIBRARY_HEADER)
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features ffi,blk,net,vhost-user --bin libkrun-gen -- rust-client --weak; } > src/libkrun-via-cdylib-weak/src/lib.rs
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features ffi,blk,net,vhost-user --bin libkrun-gen -- rust-client; } > src/libkrun-via-cdylib/src/lib.rs

# Regenerate ffier bindings for init-blob.
...
gen-init-blob-bindings:
	...
	cp target/ffier-krun_init.json include/ffier-krun_init.json
	...
	{ printf '// @generated by: make gen-init-blob-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes\n)]\n'; \
	  cargo run -p krun-init-blob --features ffi --bin krun-init-blob-gen rust-client; } > init/init-blob-via-cdylib/src/lib.rs

# Verify that checked-in generated files are up to date (for CI).
verify-init-blob-bindings: gen-init-blob-bindings
	@git diff --exit-code include/ffier-krun_init.json \
		$(LIBRARY_HEADER_INIT) \
		init/init-blob-via-cdylib/src/lib.rs \
...
$(LIBRARY_RELEASE_$(OS)): $(INIT_BINARY_BSD)
	...
	CARGO_TARGET_DIR=$(FFI_HELPER_TARGET_DIR) cargo build --release -p libkrun --features ffi,blk,net,vhost-user
