...
typedef void* KrunObject; /* KrunError | KrunMmioDeviceManager | KrunFsDevice | KrunConsoleDevice | KrunConsoleBuilder | KrunPayload | KrunVmmBuilder | KrunVmm | KrunFsOverlay | KrunBalloonDevice | KrunRngDevice */
