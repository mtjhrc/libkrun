...
typedef void* KrunObject; /* KrunError | KrunMmioDeviceManager | KrunFsDevice | KrunConsoleDevice | KrunConsoleBuilder | KrunPayload | KrunVmmBuilder | KrunVmm | KrunFsOverlay | KrunBalloonDevice | KrunRngDevice | KrunVsockDevice | KrunBlockDevice | KrunNetDevice | KrunVhostUserDevice */
 ...
 */
KrunResult krun_init_log(int32_t target_fd, uint32_t level, uint32_t style, uint32_t options, KrunError* err_out);
typedef KrunResult (*krun_init_log_fn)(int32_t target_fd, uint32_t level, uint32_t style, uint32_t options, KrunError* err_out);
