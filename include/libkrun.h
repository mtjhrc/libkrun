...
typedef void* KrunObject; /* KrunError | KrunMmioDeviceManager | KrunFsDevice | KrunConsoleDevice | KrunConsoleBuilder | KrunFsOverlay | KrunPayload | KrunNitroConfig | KrunVmmBuilder | KrunVmm | KrunVmmHandle | KrunBalloonDevice | KrunRngDevice | KrunVsockDevice | KrunBlockDevice | KrunNetDevice | KrunDisplayInfoBuilder | KrunVhostUserDevice | KrunDisplayBackend | KrunGpuDevice | KrunInputDevice */
...
#define KRUN_ERROR__MISSING_CONFIG ((uint64_t)16777229 << 32 | 2)
#define KRUN_ERROR__OUT_OF_RANGE ((uint64_t)16777229 << 32 | 3)
#define KRUN_ERROR__FILE_NOT_FOUND ((uint64_t)16777229 << 32 | 4)
#define KRUN_ERROR__RESOURCE_ALLOC ((uint64_t)16777229 << 32 | 5)
#define KRUN_ERROR__BAD_FD ((uint64_t)16777229 << 32 | 6)
#define KRUN_ERROR__FEATURE_DISABLED ((uint64_t)16777229 << 32 | 7)
#define KRUN_ERROR__BOOT_ERROR ((uint64_t)16777229 << 32 | 8)
#define KRUN_ERROR__INTERNAL ((uint64_t)16777229 << 32 | 9)
